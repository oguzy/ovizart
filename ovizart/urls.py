...
from ovizart.api.api import AppProtocolResource, AppProtocolVisualizePacketSizeResource, \
...
urlpatterns = patterns('',
    ...
    #url(r'^$', 'ovizart.main.views.login_user', name='login_page'),
    url(r'^$', 'ovizart.main.views.main', name='main_page'),
    url(r'^login/', 'ovizart.main.views.login_user', name='login_page'),
    url(r'^logout/$', 'ovizart.main.views.logout_user', name='logout_page'),
    url(r'^about/$', 'ovizart.main.views.about', name='about_page'),
    (r'^pcap/', include('ovizart.pcap.urls')),
    (r'^main/', include('ovizart.main.urls')),
