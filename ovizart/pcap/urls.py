...
from ovizart.pcap.views import *
...
urlpatterns = patterns('',
    ...
    url(r'^(?P<flow_pcap_md5>\w+)/visualize/(?P<protocol>\w+)/(?P<type>\w+)/$', view=visualize, name='visualize_app_layer'),
    url(r'^(?P<flow_pcap_md5>\w+)/visualize/$', view=create_parallel_coordinates, name='parallel_coordinates'),
